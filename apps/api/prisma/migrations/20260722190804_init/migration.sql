...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('WOMPI', 'BANK_TRANSFER', 'CASH_ON_DELIVERY');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('CUSTOMER_REGISTERED', 'ORDER_CREATED', 'ORDER_UPDATED', 'PAYMENT_UPDATED');

-- CreateEnum
CREATE TYPE "ReviewStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'STATUS_CHANGE', 'PAYMENT_WEBHOOK');
...
-- CreateIndex
CREATE INDEX "Product_brandId_categoryId_status_idx" ON "Product"("brandId", "categoryId", "status");

-- CreateIndex
CREATE INDEX "Product_price_idx" ON "Product"("price");

-- CreateIndex
CREATE INDEX "Product_character_idx" ON "Product"("character");
...
-- AddForeignKey
ALTER TABLE "MarketingLead" ADD CONSTRAINT "MarketingLead_couponId_fkey" FOREIGN KEY ("couponId") REFERENCES "Coupon"("id") ON DELETE SET NULL ON UPDATE CASCADE;
